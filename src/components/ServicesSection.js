        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div key={service.id} className="card p-6 group cursor-pointer">
              ...
              <Link to="/browse" className="block w-full bg-blue-50 hover:bg-blue-100 text-blue-600 font-medium py-2 px-4 rounded-lg transition-colors text-center">
                View Professionals
              </Link>
            </div>
          ))}
          ...
          <Link to="/browse" className="card p-6 flex flex-col items-center justify-center text-center group cursor-pointer border-2 border-dashed border-gray-300 hover:border-blue-400">
